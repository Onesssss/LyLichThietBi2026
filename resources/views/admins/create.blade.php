        ...
        <form action="{{ route('admins.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <!-- Mật khẩu -->
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; margin-bottom: 8px; font-weight: 500; color: #495057;">Mật khẩu <span style="color: red;">*</span></label>
                ...
                <div class="col-md-6">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <select name="role_id" class="form-control" style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 6px;" required>
                            ...
                            <option value="1" {{ old('role_id') == '1' ? 'selected' : '' }}>Moderator</option>
