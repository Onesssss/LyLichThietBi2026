...
<main class="main-content">
    <div class="top-bar">
        <div class="page-title">
            <h1><i class="fas fa-plus-circle"></i> Thêm chốt</h1>
        </div>
    ...
    <div class="info-note" style="margin-bottom: 20px;">
        ...
        <span>Nhập thông tin chốt mới và chọn cung tương ứng.</span>
    </div>
        ...
        <form action="{{ route('points.store') }}" method="POST">
            ...
            <div style="margin-top: 25px;">
                <button type="submit"
                    ...
                    <i class="fas fa-save"></i> Lưu chốt
                </button>
